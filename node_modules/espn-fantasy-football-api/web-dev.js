...
/* harmony import */ var _draft_player_draft_player__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../draft-player/draft-player */ "./src/draft-player/draft-player.js");
...
axios__WEBPACK_IMPORTED_MODULE_12__["default"].defaults.baseURL = 'https://lm-api-reads.fantasy.espn.com/apis/v3/games/ffl/seasons/';
...
var Client = /*#__PURE__*/function () {
  ...
  _createClass(Client, [{
    ...
    value: function getBoxscoreForWeek(_ref2) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_12__["default"].get(route, this._buildAxiosConfig()).then(function (response) {
    ...
    value: function getDraftInfo(_ref3) {
      ...
      return Promise.all([axios__WEBPACK_IMPORTED_MODULE_12__["default"].get(draftRoute, this._buildAxiosConfig()), axios__WEBPACK_IMPORTED_MODULE_12__["default"].get(playerRoute, this._buildAxiosConfig({
        headers: {
        ...
        return lodash_map__WEBPACK_IMPORTED_MODULE_2___default()(draftResponse.data.draftDetail.picks, function (draftPick) {
          var playerInfo = lodash_find__WEBPACK_IMPORTED_MODULE_1___default()(playerResponse.data.players, function (player) {
            return player.player.id === draftPick.playerId;
          });
          var data = _objectSpread(_objectSpread({}, draftPick), (0,_utils__WEBPACK_IMPORTED_MODULE_11__.flattenObjectSansNumericKeys)(playerInfo));
          return _draft_player_draft_player__WEBPACK_IMPORTED_MODULE_6__["default"].buildFromServer(data, {
            seasonId: seasonId,
            scoringPeriodId: scoringPeriodId
          });
        });
    ...
    value: function getHistoricalScoreboardForWeek(_ref6) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_12__["default"].get(route, axiosConfig).then(function (response) {
    ...
    value: function getFreeAgents(_ref7) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_12__["default"].get(route, config).then(function (response) {
    ...
    key: "getTeamsAtWeek",
    value: function getTeamsAtWeek(_ref8) {
      var _this4 = this;
      ...
      return axios__WEBPACK_IMPORTED_MODULE_12__["default"].get(route, this._buildAxiosConfig()).then(function (response) {
        return _this4._parseTeamResponse(response.data, seasonId, scoringPeriodId);
      });
    }
    ...
    value: function getHistoricalTeamsAtWeek(_ref9) {
      var _this5 = this;
      ...
      return axios__WEBPACK_IMPORTED_MODULE_12__["default"].get(route, axiosConfig).then(function (response) {
        return (
          ...
          _this5._parseTeamResponse(response.data[0], seasonId, scoringPeriodId)
        );
      });
    }
  }, {
    ...
    value: function _parseTeamResponse(responseData, seasonId, scoringPeriodId) {
      ...
      var teams = lodash_get__WEBPACK_IMPORTED_MODULE_4___default()(responseData, 'teams');
      var members = lodash_get__WEBPACK_IMPORTED_MODULE_4___default()(responseData, 'members');
      var mergedData = lodash_map__WEBPACK_IMPORTED_MODULE_2___default()(teams, function (team) {
      ...
      return lodash_map__WEBPACK_IMPORTED_MODULE_2___default()(mergedData, function (team) {
    ...
    value: function getNFLGamesForPeriod(_ref10) {
    ...
    key: "getLeagueInfo",
    value: function getLeagueInfo(_ref11) {
      var _this7 = this;
      var seasonId = _ref11.seasonId;
      ...
      return axios__WEBPACK_IMPORTED_MODULE_12__["default"].get(route, this._buildAxiosConfig()).then(function (response) {
        var settingsData = lodash_get__WEBPACK_IMPORTED_MODULE_4___default()(response.data, 'settings');
        var statusData = lodash_get__WEBPACK_IMPORTED_MODULE_4___default()(response.data, 'status');
    ...
    key: "_buildRoute",
    value: function _buildRoute(_ref12) {
